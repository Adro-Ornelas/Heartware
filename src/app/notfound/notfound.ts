...
<div class="flex items-center justify-center min-h-screen overflow-hidden">
    <div class="flex flex-col items-center justify-center">
        ...
        <img src="images/favicon.webp" alt="Heartware logo" style="height: 50px;" />
                <span class="text-primary font-bold text-3xl mb-1">404</span>
                <h1 class="text-surface-900 dark:text-surface-0 font-bold text-3xl lg:text-5xl mb-3">Página no encontrada</h1>
                <div class="text-surface-600 dark:text-surface-200 mb-8 text-center">Lo lamentamos, la página que buscas no existe o se a movidos</div>
